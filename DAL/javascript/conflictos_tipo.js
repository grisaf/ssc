...
//var serverName = 'http://192.168.70.102/';
...
function defineDataTable() {
    oTable = $('#tableList').dataTable( {
        ...
        "iDisplayLength": 50,
        "bSortClasses": false,
        "sAjaxSource": serverName + '?q=getAllTipos&o=aaData',
        "aoColumns": [
            { "mDataProp": "tipo", "sTitle": "Descripcion"},
...
function editData() {
    ...
    $.post( serverName, { q:'postTipo', a: 'u', id: id, va: description },
    function(data) {
        refreshTable();
        displayEditionPanel( false );
    });
...
function addData() {
    ...
    $.post( serverName, { q:'postTipo', a: 'i', va: description },
    function(data) {
        refreshTable();
        displayEditionPanel( false );
    });
...
function deleteData( id, event ) {
    ...
    $.post( serverName, { q:'postTipo', a: 'd', id: id },
    function(data) {
        refreshTable();
    });
}
